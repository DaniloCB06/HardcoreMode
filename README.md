...
*   **TinyMessage API**: Enhanced red chat messages for Blood Moon announcements. Falls back to plain text if not present. ([https://www.curseforge.com/hytale/mods/tinymessage](https://www.curseforge.com/hytale/mods/tinymessage))
*   **RPGLeveling Mod**: Custom XP multipliers during Blood Moon events. Automatically detected. ([https://www.curseforge.com/hytale/mods/rpg-leveling-and-stats](https://www.curseforge.com/hytale/mods/rpg-leveling-and-stats))
...
![image](https://media.forgecdn.net/attachments/description/1439115/description_6325d635-5c48-4694-b35a-a7d934ab8bdc.png)

*   **Mob Categories Manager**: View and configure creature classifications
*   **Blood Moon Drops Manager**: Configure custom loot tables
*   **World Settings**: Enable or Disable HardcoreMode effects for specific worlds in universe
...
![image](https://media.forgecdn.net/attachments/description/1439115/description_33e764ea-433f-4cb7-9b7f-04b14e4afa68.png)
...
*   **Category Disable**: Disabling a category removes all buffs, even during Blood Moon (unless the Blood Moon category is enabled)
